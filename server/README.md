...
$ curl http://localhost:8080/authorized -H "Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6Im1hcmlhIiwic3ViIjoyLCJpYXQiOjE2NTE0MjQ3MjMsImV4cCI6MTY1MTUxMTEyM30.Z7CWducioDs7JeSwyNIWmPhRBLb_haKvlXsLeTERJyk"
$ # result -> {"userId":2}
```
